package api.AllFunctions.security;
...
public class CreateToken {
    ...
    public static String create(String prefix,String key, ObjectsToken jwtObject) {
    ...
    public static ObjectsToken create(String token,String prefix,String key)
            throws ExpiredJwtException, UnsupportedJwtException, MalformedJwtException, SignatureException {
        ObjectsToken object = new ObjectsToken();
